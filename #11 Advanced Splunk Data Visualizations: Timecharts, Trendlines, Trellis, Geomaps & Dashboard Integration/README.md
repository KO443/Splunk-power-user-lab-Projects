...
2. I then added this visualization to a new dashboard titled Visualization Part 2 and the dashboard panel is titled "Total Events week to date", showcasing the timechart and moving average results.
...
4. I also added another search query to regions with the least amount of sales by filtering purchase events from the **web index**, enriching them with geographic data using** iplocation**, mapping the **counts** with **geostats**, and then applying a where clause to isolate locations with fewer than 100 purchases.I added this to a dashboard titled **"Region with most lease of sale"**
